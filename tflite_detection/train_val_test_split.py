...
image_path = '/mydrive2/tflite/images/all'
train_path = '/mydrive2/tflite/images/train'
val_path = '/mydrive2/tflite/images/validation'
test_path = '/mydrive2/tflite/images/test'
